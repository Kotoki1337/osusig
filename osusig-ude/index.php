...
<article>
    <a href="/osusig" class="button">Bancho</a>
    <a href="/osusig-sb" class="button">osu.ppy.sb</a>
    <a href="/osusig-ude" class="button">osu!ude</a>
    <a href="/osusig-akatsuki" class="button">Akatsuki</a>
    <a href="http://sig.gatari.pw/" target="_blank" class="button">Gatari</a>
    <a href="/osusig-ripple" target="_blank" class="button">Ripple</a>
</article>
